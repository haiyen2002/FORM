      ...
      template={(props) => (
        <section
          ...
          style={{
            ...
            padding: isVertical ? "44px 36px 90px" : "44px 54px 90px 132px",
          }}
        >
          ...
          <div className="w-full h-full">
                    ...
                    {data.data
                      ...
                      .map((item: any, index: number) => (
                        <tr key={index} className={styles.row}>
                          ...
                          <td className="break-all">{item.ref_no}</td> */}
                        </tr>
                      ))}
            ...
            {props.dataPage.hasLast && (
              <div className="mt-5 mb-[75px] flex justify-between">
            ...
            {props.dataPage.isSigned && (
              <>
                <p className={cn("font-bold flex justify-between")}>
